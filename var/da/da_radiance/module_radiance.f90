module module_radiance
  ...
  Character (len=9), Parameter :: rttov_platform_name(1:59) =          &  !Character (len=8), Parameter :: rttov_platform_name(1:35) =          &
...
CHARACTER(LEN=8), dimension(0:140):: rttov_inst_name =                & !  CHARACTER(LEN=8), dimension(0:88):: rttov_inst_name = 
  ...
  Character (len=9), Parameter :: crtm_platform_name(1:59) =           &
     & (/ 'n        ', 'f        ', 'm        ', 'g        ', 'gms      ',  &
        & 'xxxxxxxxx', 'trmm     ', 'ers      ', 'eos      ', 'metop    ',  &
        & 'envisat  ', 'msg      ', 'xxxxxxxxx', 'xxxxxxxxx', 'mt       ',  &
        & 'coriolis ', 'npp      ', 'gifts    ', 'tiros    ', 'meghat   ',  &
        & 'kalpana  ', 'tiros    ', 'fy3      ', 'coms     ', 'xxxxxxxxx',  &
        & 'xxxxxxxxx', 'xxxxxxxxx', 'reserved ', 'gcom-w   ', 'xxxxxxxxx',  &
        & 'himawari ', 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx',  &
        & 'jason    ', 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx',  &
        & 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx',  &
        & 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx',  &
        & 'xxxxxxxxx', 'fy4      ', 'xxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxx',  &
  ...
  ! used in crtm coeff names, they will be re-set in
  ! da_crtm_sensor_descriptor.inc
  Character (len=8), Dimension(0:140) :: crtm_sensor_name  =            &
     & (/ 'hirs    ', 'msu     ', 'ssu     ', 'amsua   ', 'amsub   ',  &
        ...
        & 'xxxxxxxx', 'xxxxxxxx', 'mwts2   ', 'mwhs2   ', 'xxxxxxxx',  &
        & 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx',  &
        & 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx',  &
        & 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx',  &
        & 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx',  &
        ...
        & 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx',  &
        & 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx',  &
        & 'xxxxxxxx', 'xxxxxxxx', 'mwts3   ', 'xxxxxxxx', 'xxxxxxxx',  &
        & 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx',  &
        & 'mwhs2e  ' /)
